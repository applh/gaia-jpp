...
let data_store = (
  ([__temp,__restore] = withAsyncContext(() => __vitePreload(() => import('./index-fbbdd6e6.js').then(n => n.a8),true?["./index-fbbdd6e6.js","./index-06122cba.css"]:void 0,import.meta.url))),
  __temp = await __temp,
  __restore(),
  __temp
);
